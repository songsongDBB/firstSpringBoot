...
public class GirlController {
    ...
    public Result<Girl> girlAdd(@Valid Girl girl, BindingResult bindingResult){
        ...
        if(bindingResult.hasErrors()){
            return ResultUtil.retrunResult(ResultEnum.VERIFY_ERROR.getCode(), bindingResult.getFieldError().getDefaultMessage(), null);
        }

        return ResultUtil.retrunResult(ResultEnum.SUCCESS.getCode(), ResultEnum.SUCCESS.getMsg(), girlRepository.save(girl));
    }
